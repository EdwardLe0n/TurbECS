...
use turbe::component_system::{component::ComponentData, component_types::ComponentTypes};
...
impl TextBoxFillerComponent {
    ...
    pub fn on_awake(&mut self, ent : &mut Entity) {
        ...
        let some_locat = ent.find_component(ComponentTypes::TextBox);
        ...
        if some_locat.0 {
            ...
            if let ComponentData::TextBox(some_text_box) = &mut ent.components[self.locat].component_data {
