...
use crate::kitchen::sceneManagementSystem;
...
turbo::go! ({
    ...
    sceneManagementSystem::check_scene();

    objectManager::manage_new_objects();

    objectManager::manage_awake();

    objectManager::manage_start();

    objectManager::manage_update();

    // objectManager::manage_destroy();

    objectManager::manage_render();
